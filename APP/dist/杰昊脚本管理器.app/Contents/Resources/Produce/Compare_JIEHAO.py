...
BACKUP_SUBFOLDER = BACKUP_COMPARE_JIEHAO
...
# ================= 从 Prompt 模块导入提示词 =================
from Prompt.Compare_JIEHAO_User_Prompt import USER_PROMPT_TEMPLATE
from Prompt.Compare_JIEHAO_System_Prompt import get_base_article_system_prompt
...
def main():
    ...
    if AUTO_GIT_PUSH and success_count > 0:
        print("\n" + "=" * 60)
        commit_msg = f"Auto generate: {success_count} base article(s) with card-drawing"
