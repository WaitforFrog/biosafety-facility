"""
Compare_Neutral_System_Prompt.py
Compare_Neutral 模块专用的 System Prompt
（与 Compare_JIEHAO_System_Prompt 完全一致，无需修改）
"""
...
(Use this as background reference; when mentioning companies, maintain objectivity and neutrality, focusing on technical parameters and avoiding marketing language)
...
def get_base_article_system_prompt(current_time: str = "") -> str:
    """拼接 Compare_Neutral 文章的完整 System Prompt"""
