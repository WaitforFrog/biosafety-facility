"""
Installation_Neutral_System_Prompt.py
Installation 模块专用的 System Prompt（中立版）

此文件与 Installation_JIEHAO_System_Prompt.py 完全一致，未做任何修改。
"""
...
def get_installation_article_system_prompt(current_time: str = "") -> str:
    """拼接 Installation 文章的完整 System Prompt"""
