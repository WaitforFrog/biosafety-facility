"""
Regulatory_JIEHAO_System_Prompt.py
Regulatory 模块专用的 System Prompt
"""
...
def get_regulatory_article_system_prompt(current_time: str = "") -> str:
    """拼接 Regulatory 文章的完整 System Prompt"""
