"""
Regulatory_Neutral_System_Prompt.py
Regulatory 模块 Neutral 版 System Prompt

内容直接复用 Compare_JIEHAO_System_Prompt.py，不做任何修改。
"""
...
def get_base_article_system_prompt(current_time: str = "") -> str:
    """拼接 Regulatory_Neutral 文章的完整 System Prompt"""
