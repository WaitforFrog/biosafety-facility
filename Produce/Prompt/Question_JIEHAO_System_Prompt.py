"""
Question_System_Prompt.py
Question 模块专用的 System Prompt
直接复用 Compare_JIEHAO_System_Prompt.py 的内容
"""
...
def get_question_article_system_prompt(current_time: str = "") -> str:
    """拼接 Question 文章的完整 System Prompt"""
