...
BACKUP_SUBFOLDER = BACKUP_INSTALL_JIEHAO
...
# ================= 从 Prompt 模块导入提示词 =================
from Prompt.Installation_JIEHAO_User_Prompt import USER_PROMPT_TEMPLATE
from Prompt.Installation_JIEHAO_System_Prompt import get_installation_article_system_prompt
...
def main():
    ...
    if AUTO_GIT_PUSH and success_count > 0:
        print("\n" + "=" * 60)
        commit_msg = f"Auto generate: {success_count} installation article(s) with card-drawing"
