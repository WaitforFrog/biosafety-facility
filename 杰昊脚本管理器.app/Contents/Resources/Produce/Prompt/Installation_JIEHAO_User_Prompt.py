# pyright: ignore
"""
Installation_JIEHAO_User_Prompt.py
Installation 模块专用的 User Prompt 模板

改动点：
1. Step 1 Thematic Anchoring 改为安装调试导向
2. 标题生成规则改为安装调试视角
3. FAQ内容改为安装调试相关
4. 文章结构说明强调 操作步骤 → 技术参数 → 验收标准 三段式
"""
...
Q: During {english_product_name} site acceptance, what specific documentation should the manufacturer provide to verify that the airtight sealing system was factory-tested and field-verified?
