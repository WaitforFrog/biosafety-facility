# pyright: ignore
"""
Question_JIEHAO_User_Prompt.py
Question 模块专用的 User Prompt 模板

基于 Compare_JIEHAO_User_Prompt.py 改编：
- 文章类型从"对比选型"改为"问题诊断与解决方案"
- 标题生成规则从"避坑选型"改为"故障排查"
- FAQ从"怎么选供应商"改为"出了问题怎么办"
- 暗广插入逻辑和字符预算控制完全保留
"""
...
Q: When an {english_product_name} fails its pressure decay test during commissioning, what specific support should buyers request from the supplier to resolve the issue within the FAT window?
